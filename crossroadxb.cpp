...
void CrossroadXb::on_buttonC7_clicked()
{
...
void CrossroadXb::smartTimeout()
{
    ...
    if(smartIt == 1) {
        ...
        if(previouslyExtended == false) {
            float ext1 = fuzzyBrain(_s2_2->queueLength(), _s2_2->arrivalRate());
...
void CrossroadXb::setupColumns()
{
    ...
    _s3_1 = new Column(this, 9, Direction::DOWN, 232, 15, 40, 15);
    ...
    connect(_s3_2, &Column::increaseTotalCars, this, &CrossroadXb::increaseSmart);

    _s2_2 = new Column(this, 9, Direction::LEFT, 36, 300, 15, 40);
    ...
    _c3_1 = new Column(this, 9, Direction::DOWN, 810, 15, 40, 15);
    ...
    connect(_c3_2, &Column::increaseTotalCars, this, &CrossroadXb::increaseSmart);

    _c2_2 = new Column(this, 9, Direction::LEFT, 616, 300, 15, 40);
